 ...
 *-----------------------------------------------------------------------------------*/
//KeyBufのビットを変更する。
bool SetKeyState(int *KeyBuf, int key, bool onoff, int *Keys, char size);

//状態を取得。押されていたらtrue
bool GetKeyState(int *KeyBuf, int key, int *Keys, char size);	//自前でKeyBufのビットを調べることをおすすめする。
